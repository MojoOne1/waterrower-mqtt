...
const I18N = {
  de: {
    ...
    zeroMonitor: "Beenden & nullen",
    confirmZero: "Einheit beenden und den Monitor auf null setzen?",
  ...
  en: {
    ...
    zeroMonitor: "End & zero",
    confirmZero: "End the session and set the monitor back to zero?",
    endSent: "Ending …",
